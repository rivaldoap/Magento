...
WebUI.click(findTestObject('Object Repository/Sign In/btn_Sign In atas'))
	...
	//Entering Women Page
	WebUI.click(findTestObject('Object Repository/Women/btn_Women'))
	//WebUI.click(findTestObject('Object Repository/Women/btn_Tops'))
	WebUI.click(findTestObject('Object Repository/Women/btn_Jackets'))