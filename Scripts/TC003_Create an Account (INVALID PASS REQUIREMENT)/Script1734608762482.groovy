...
WebUI.click(findTestObject('Object Repository/Create an Account/Create an Account'))
	...
	//Create an Account (Invalid Password Requirement. Need a combination Lower Case, Upper Case, Digits, Special Character)
	//In this case I try without Upper Case
	WebUI.setText(findTestObject('Object Repository/Create an Account/Email'), 'qnbdysbdy12345@mail.co')
