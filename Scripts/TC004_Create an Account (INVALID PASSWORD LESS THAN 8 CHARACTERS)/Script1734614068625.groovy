...
WebUI.click(findTestObject('Object Repository/Create an Account/Create an Account'))
	...
	//Create an Account (PASSWORD LESS THAN 8 CHARACTERS)
	WebUI.setText(findTestObject('Object Repository/Create an Account/Email'), 'ynbdysbdy12345@mail.co')
	WebUI.setText(findTestObject('Object Repository/Create an Account/Password'), 'Abc123!')
	WebUI.setText(findTestObject('Object Repository/Create an Account/Confirm Password'), 'Abc123!')
